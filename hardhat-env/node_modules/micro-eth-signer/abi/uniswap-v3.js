...
import { add0x, createDecimal } from "../utils.js";
...
const ABI_MULTICALL = /* @__PURE__ */ addHook(_ABI, 'multicall', (d, contract, info, opt) => {
...
const decodePath = (b) => [b.slice(0, 20), b.slice(-20)].map((i) => add0x(bytesToHex(i)));
...
const ABI = /* @__PURE__ */ addHints(ABI_MULTICALL, hints);
export default ABI;
