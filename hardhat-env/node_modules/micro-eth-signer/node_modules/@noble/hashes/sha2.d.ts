...
export declare class SHA256 extends SHA2_32B<SHA256> {
    protected A: number;
    protected B: number;
    protected C: number;
    protected D: number;
...
export declare class SHA224 extends SHA2_32B<SHA224> {
    protected A: number;
    protected B: number;
    protected C: number;
    protected D: number;
...
export declare abstract class SHA2_64B<T extends SHA2_64B<T>> extends HashMD<T> {
...
export declare class SHA512 extends SHA2_64B<SHA512> {
    protected Ah: number;
    protected Al: number;
    protected Bh: number;
    protected Bl: number;
...
export declare class SHA384 extends SHA2_64B<SHA384> {
    protected Ah: number;
    protected Al: number;
    protected Bh: number;
    protected Bl: number;
...
export declare class SHA512_224 extends SHA2_64B<SHA512_224> {
    protected Ah: number;
    protected Al: number;
    protected Bh: number;
    protected Bl: number;
...
export declare class SHA512_256 extends SHA2_64B<SHA512_256> {
    protected Ah: number;
    protected Al: number;
    protected Bh: number;
    protected Bl: number;
 ...
 */
export declare const sha256: CHash<SHA256>;
/** SHA2-224 hash function from RFC 4634 */
export declare const sha224: CHash<SHA224>;
/** SHA2-512 hash function from RFC 4634. */
export declare const sha512: CHash<SHA512>;
/** SHA2-384 hash function from RFC 4634. */
export declare const sha384: CHash<SHA384>;
/**
 * SHA2-512/256 "truncated" hash function, with improved resistance to length extension attacks.
 * See the paper on [truncated SHA512](https://eprint.iacr.org/2010/548.pdf).
 */
export declare const sha512_256: CHash<SHA512_256>;
/**
 * SHA2-512/224 "truncated" hash function, with improved resistance to length extension attacks.
 * See the paper on [truncated SHA512](https://eprint.iacr.org/2010/548.pdf).
 */
export declare const sha512_224: CHash<SHA512_224>;
export {};
