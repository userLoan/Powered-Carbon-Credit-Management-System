...
export declare abstract class BLAKE2<T extends BLAKE2<T>> implements Hash<T> {
 ...
 */
export declare const blake2b: CHash<BLAKE2b, Blake2Opts>;
export type Num16 = {
    v0: number;
    v1: number;
    v2: number;
 ...
 * @param opts - dkLen output length, key for MAC mode, salt, personalization
 */
export declare const blake2s: CHash<BLAKE2s, Blake2Opts>;
