...
export declare class BLAKE224 extends BLAKE1_32B {
    constructor(opts?: BlakeOpts);
}
export declare class BLAKE256 extends BLAKE1_32B {
    constructor(opts?: BlakeOpts);
}
export declare class BLAKE384 extends BLAKE1_64B {
    constructor(opts?: BlakeOpts);
}
export declare class BLAKE512 extends BLAKE1_64B {
    constructor(opts?: BlakeOpts);
}
/** blake1-224 hash function */
export declare const blake224: CHash<BLAKE224, BlakeOpts>;
/** blake1-256 hash function */
export declare const blake256: CHash<BLAKE256, BlakeOpts>;
/** blake1-384 hash function */
export declare const blake384: CHash<BLAKE384, BlakeOpts>;
/** blake1-512 hash function */
export declare const blake512: CHash<BLAKE512, BlakeOpts>;
export {};
